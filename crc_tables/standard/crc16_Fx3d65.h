...
static uint16_t const crc16_Fx3d65_tbl[256] =
{
...
make_crc_kernel_f16_t8(Fx3d65)

#else

static uint16_t const crc16_Fx3d65_tbl[16] =
{
    0x0000, 0x3d65, 0x7aca, 0x47af, 0xf594, 0xc8f1, 0x8f5e, 0xb23b,
    0xd64d, 0xeb28, 0xac87, 0x91e2, 0x23d9, 0x1ebc, 0x5913, 0x6476
};

make_crc_kernel_f16_t4(Fx3d65)
