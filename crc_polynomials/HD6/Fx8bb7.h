...
// HD3                  :      <= 65519 bits, 8189 bytes
// HD4                  :      <=   353 bits,   44 bytes
// HD5                  :      <=    47 bits,    5 bytes
// HD6                  :      <=    23 bits,    2 bytes
// HD7                  :      <=     8 bits,    1 byte
// Implicit             :      0xc5db
// Explicit             :      0x18bb7
// Reversed Implicit    :      0xedd1
// Reversed Explicit    :      0x1dba3

#include "crc_kernels/crc_kernel_tables.h"

#if defined (USE_CRC_KERNEL_TABLE8)

static uint16_t const Fx8bb7[256] =
{
...
make_crc_kernel_f16_t8(Fx8bb7)

#else

static uint16_t const Fx8bb7[16] =
{
  0x0000, 0x8bb7, 0x9cd9, 0x176e, 0xb205, 0x39b2, 0x2edc, 0xa56b, 0xefbd, 0x640a, 0x7364, 0xf8d3, 0x5db8, 0xd60f, 0xc161, 0x4ad6
};

make_crc_kernel_f16_t4(Fx8bb7)
